...
?>
    ...
    <header id="intro" class="hero stone-texture">
        <div class="hero-content purple-shadow">
            ...
            <div>
                ...
                <?php editableText('mission_tagline_index', $pdo, 'Promocionamos el turismo en Cerezo de Río Tirón y cuidamos su patrimonio arqueológico y cultural.', 'p', 'mission-tagline shine-gold'); ?>
            </div>
        </div>
