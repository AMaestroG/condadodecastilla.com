...
<body class="alabaster-bg">
    ...
    <header class="page-header hero" style="background-image: linear-gradient(rgba(var(--color-primario-purpura-rgb), 0.7), rgba(var(--color-negro-contraste-rgb), 0.85)), url('/assets/img/hero_historia_background.jpg');">
        <div class="hero-content">
            <h1 class="gradient-text shine-gold purple-shadow">Línea de Tiempo de Nuestra Historia</h1>
                ...
                <ul class="timeline">
                    <li class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <h3 class="gradient-text shine-gold purple-shadow">Prehistoria: Atapuerca y Primeros Pobladores</h3>
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <h3 class="gradient-text shine-gold purple-shadow">Pueblos Prerromanos: Berones, Autrigones y Cántabros</h3>
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <h3 class="gradient-text shine-gold purple-shadow">Romanización: Auca Patricia y el Legado Imperial</h3>
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <h3 class="gradient-text shine-gold purple-shadow">Época Visigoda: Continuidad y Transformación</h3>
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <h3 class="gradient-text shine-gold purple-shadow">Presencia Árabe y Resistencia Cristiana (Siglos VIII-X)</h3>
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <h3 class="gradient-text shine-gold purple-shadow">Alta Edad Media: El Nacimiento del Condado de Castilla</h3>
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <h3 class="gradient-text shine-gold purple-shadow">Explorando Auca Patricia, Cerasio y los Orígenes de Castilla</h3>
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <h3 class="gradient-text shine-gold purple-shadow">Documentos Históricos del Condado</h3>
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <h3 class="gradient-text shine-gold purple-shadow">Galería Visual de la Historia</h3>
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <h3 class="gradient-text shine-gold purple-shadow">Plena y Baja Edad Media: Consolidación y Señoríos</h3>
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <h3 class="gradient-text shine-gold purple-shadow">Edad Moderna y Contemporánea: De los Austrias a Nuestros Días</h3>
