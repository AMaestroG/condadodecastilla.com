...
<head>
    ...
    <title>Nuestra Historia: Línea de Tiempo - Condado de Castilla</title>
                ...
                <ul class="timeline">
                    <li class="timeline-item">
                        <div class="timeline-icon">
                            <img src="/imagenes/estrella.png" alt="Hito en la línea de tiempo: Prehistoria">
                        </div>
                        <div class="timeline-content">
                            ...
                            <a href="#prehistoria-detalle" class="read-more timeline-read-more">Explorar Prehistoria</a>
                        </div>
                    </li>
                    <li class="timeline-item">
                        <div class="timeline-icon">
                             <img src="/imagenes/estrella.png" alt="Hito en la línea de tiempo: Pueblos Prerromanos">
                        </div>
                        <div class="timeline-content">
                    ...
                    <li class="timeline-item">
                        <div class="timeline-icon">
                             <img src="/imagenes/estrella.png" alt="Hito en la línea de tiempo: Romanización">
                        </div>
                        <div class="timeline-content">
                    ...
                    <li class="timeline-item">
                        <div class="timeline-icon">
                             <img src="/imagenes/estrella.png" alt="Hito en la línea de tiempo: Época Visigoda">
                        </div>
                        <div class="timeline-content">
                    ...
                    <li class="timeline-item">
                        <div class="timeline-icon">
                             <img src="/imagenes/estrella.png" alt="Hito en la línea de tiempo: Presencia Árabe">
                        </div>
                        <div class="timeline-content">
                    ...
                    <li class="timeline-item">
                        <div class="timeline-icon">
                             <img src="/imagenes/estrella.png" alt="Hito en la línea de tiempo: Alta Edad Media">
                        </div>
                        <div class="timeline-content">
                    ...
                    <li class="timeline-item">
                        <div class="timeline-icon">
                            <img src="/imagenes/estrellaGordita.png" alt="Hito en la línea de tiempo: Explorando los Orígenes de Castilla">
                        </div>
                        <div class="timeline-content">
                            ...
                            <a href="/historia/nuestra_historia_nuevo4.html" class="read-more timeline-read-more">Leer Más Sobre los Orígenes de Castilla</a>
                        </div>
                    </li>
                    <li class="timeline-item">
                        <div class="timeline-icon">
                             <img src="/imagenes/estrella.png" alt="Hito en la línea de tiempo: Plena y Baja Edad Media">
                        </div>
                        <div class="timeline-content">
                    ...
                    <li class="timeline-item">
                        <div class="timeline-icon">
                             <img src="/imagenes/estrella.png" alt="Hito en la línea de tiempo: Edad Moderna y Contemporánea">
                        </div>
                        <div class="timeline-content">
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="social-links">
                <a href="#" aria-label="Facebook" title="Síguenos en Facebook"><i class="fab fa-facebook-f"></i></a>
