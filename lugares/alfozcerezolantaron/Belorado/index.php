...
<body class="alabaster-bg">
  ...
  <h1 class="gradient-text">Belorado</h1>
  <p>Bienvenido al archivo del pueblo de <strong>Belorado</strong>, integrante del histórico Alfoz de Cerezo y Lantarón.</p>
  <p><a href="/lugares/lugares.php" class="back-link">&laquo; Volver al Índice de Lugares</a></p>
  <h2>Historia</h2>
  <p>Perteneciente al <a href="/alfoz/alfoz.php">Alfoz de Cerasio y Lantarón</a>. El origen de Belorado es celta, probablemente autrigón, como demuestra la arqueología y epigrafía (estelas, teselas hospitales, monedas), aunque se configura como villa en la Edad Media siendo frontera entre los reinos de Castilla y Navarra.</p>
  <p>Era el paso natural del Valle del Ebro a la Meseta y para controlarlo se construyó, a comienzos de la Reconquista, el Castillo sobre un cerro a cuyo pie se trasladó la población que tuvo su origen al otro lado del río en época romana.</p>
