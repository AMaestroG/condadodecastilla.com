...
<div id="consolidated-menu-items" class="menu-panel left-panel vertical-tabs">
    ...
    <div class="tab-container">
        <div class="tab-headers" role="tablist">
            <button class="tab-header" role="tab" aria-controls="tab-main" data-tab-target="tab-main" id="tab-main-header">Navegación Principal</button>
            <button class="tab-header" role="tab" aria-controls="tab-tools" data-tab-target="tab-tools" id="tab-tools-header">Herramientas</button>
            <button class="tab-header" role="tab" aria-controls="tab-admin" data-tab-target="tab-admin" id="tab-admin-header">Admin</button>
            <button class="tab-header" role="tab" aria-controls="tab-social" data-tab-target="tab-social" id="tab-social-header">Social</button>
        </div>
