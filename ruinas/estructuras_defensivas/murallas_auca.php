...
<nav aria-label="breadcrumb" class="container breadcrumb-nav">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Murallas de Auca Patricia</li>
  </ol>
</nav>
    <main>
        <section class="section">
            <div class="container-epic">
                ...
                <p>Según <em>nuevo4.md</em>, las murallas de Auca Patricia se
                complementaban con fosos provistos de puentes romanos, algunos
                adaptados más tarde como levadizos. Su magnitud y la existencia
                de tramos tallados directamente en la roca muestran una
                fortaleza comparable a la de otras capitales romanas como
                Mérida.</p>
            </div>
        </section>
    </main>
