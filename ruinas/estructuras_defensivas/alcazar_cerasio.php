...
<nav aria-label="breadcrumb" class="container breadcrumb-nav">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Alcázar de Cerasio</li>
  </ol>
</nav>
    <main>
        <section class="section">
            <div class="container-epic">
                ...
                <p>Las descripciones de <em>nuevo4.md</em> sitúan varias torres defensivas a lo largo de la loma y mencionan la existencia de un "gajo de naranja" que corresponde a la antigua alcazaba. Aun cuando gran parte de la estructura está arruinada, se conservan tramos de muralla tallados en la roca que evidencian la magnitud del recinto.</p>
            </div>
        </section>
    </main>
