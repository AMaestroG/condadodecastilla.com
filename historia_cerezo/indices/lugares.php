...
<h1>Índice de Lugares Relevantes</h1>
    <ul>
        ...
        <li>Puerto Fluvial (Gurugú / Glera de los Celox): <a href="../capitulo1/capitulo1.php#evidencias-romanas">Mencionado en Capítulo 1: Evidencias de una gran ciudad romana (Puerto Fluvial)</a></li>
        <li>Episcopi de San Martín: <a href="../capitulo3/capitulo3.php#estructuras">Mencionado en Capítulo 3: Estructuras (Episcopi San Martín)</a></li>
        <li>Circo Romano de Quintanilleja: <a href="../capitulo3/capitulo3.php#estructuras">Mencionado en Capítulo 3: Estructuras (Circo Romano)</a></li>
        <li>Cuevas de Setefenestras: <a href="../capitulo3/capitulo3.php#estructuras">Mencionado en Capítulo 3: Estructuras (Cuevas de Setefenestras)</a></li>
