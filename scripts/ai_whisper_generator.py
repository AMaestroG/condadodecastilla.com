...
ERA_KEYWORDS = [
    "a forgotten age",
    "an era of upheaval",
    "a time of nascent kingdoms",
    "an age of empires",
    "a period of profound faith",
    "an epoch of legends",
]
...
def generate_whisper(character_data):
    ...
    if len(name) > 30 and (
        name.startswith("Conde") or name.startswith("Doña") or name.startswith("San")
    ):
    ...
    if fact == "their unrecorded deeds" and bio_keyword != "a notable deed":
        templates.append(
            f"Though details are lost, the essence of {name} – their {bio_keyword} – remains palpable."
        )
...
if __name__ == "__main__":
    ...
    sample_data_2 = {
        ...
        "key_facts": [
            "Married Fernando I of León",
            "Patron of several monasteries",
            "Influenced religious policy",
        ],
    ...
    sample_data_4 = {
        ...
        "key_facts": [
            "Preached Christianity in Auca Patricia and Cerasio",
            "Martyred for his faith",
            "Relics venerated in Cerezo and elsewhere",
        ],
